...
public:
  ...
  /// Test whether if a given member suppression specification matches a
  /// member denoted by its own and class' names.
  ///
  ...
  ///
  /// @return true iff the suppression specification @p s matches the
  /// member whose name is @p member_name and class is @p class_name.
  bool
